...
public class AdminController implements Initializable {
    ...
    @FXML
    public void switchtoEmployeeForm(ActionEvent event)throws IOException
    {
        Parent LoginForm= FXMLLoader.load(getClass().getResource("/Employee/Employee.fxml"));
    ...
    @FXML
    public void switchtoCustomerForm(ActionEvent event)throws IOException
    {
        Parent LoginForm= FXMLLoader.load(getClass().getResource("/Admin/Customer.fxml"));
        Scene loginScene=new Scene(LoginForm);
        //this line gets the Stage info
        Stage window=(Stage)((Node)event.getSource()).getScene().getWindow();
        window.setScene(loginScene);
    ...
    @FXML
    public void switchtoSupplierForm(ActionEvent event)throws IOException
    {
        Parent LoginForm= FXMLLoader.load(getClass().getResource("/Suppliers/Supplier.fxml"));
        Scene loginScene=new Scene(LoginForm);
        //this line gets the Stage info
        Stage window=(Stage)((Node)event.getSource()).getScene().getWindow();
        window.setScene(loginScene);
    ...
    @FXML
    public void switchtoDrugsForm(ActionEvent event)throws IOException
    {
        Parent LoginForm= FXMLLoader.load(getClass().getResource("/Drugs/DrugFXML.fxml"));
        Scene loginScene=new Scene(LoginForm);
        //this line gets the Stage info
        Stage window=(Stage)((Node)event.getSource()).getScene().getWindow();
        window.setScene(loginScene);
    ...
    {
        Parent LoginForm= FXMLLoader.load(getClass().getResource("/MainForm/Home.fxml"));
        Scene loginScene=new Scene(LoginForm);
        //this line gets the Stage info
        Stage window=(Stage)((Node)event.getSource()).getScene().getWindow();
        window.setScene(loginScene);
